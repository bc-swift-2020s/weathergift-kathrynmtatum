...
//  Weather Gift
//
//  Created by Kathryn Tatum on 3/30/20.
...
class HourlyCollectionViewCell: UICollectionViewCell {
    ...
    @IBOutlet weak var hourlyPrecipProbablility: UILabel!
    ...
    var hourlyWeather: HourlyWeather! {
        didSet {
            ...
            hourlyPrecipProbablility.text = "\(hourlyWeather.hourlyPrecipProbability)%"
            if hourlyWeather.hourlyPrecipProbability >= 20 {
                hourlyPrecipProbablility.isHidden = false
                raindropImageView.isHidden = false
            } else {
                hourlyPrecipProbablility.isHidden = true
